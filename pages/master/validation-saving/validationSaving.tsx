...
import SaveValidationRegionTable from "./component/saveValidationRegionalTable";

const validationSaving = () => {
  const breadcrumbItems: MenuItem[] = [
    { label: "Validasi Simpanan", url: "/master/validation-saving" },
  ];
...
export default validationSaving;
