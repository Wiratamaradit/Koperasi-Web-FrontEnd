...
export const productSegmentCreateSlice = createSlice({
    name: 'productSegmentPost',
...
export const {requestStart, requestSuccess, requestFailure} = productSegmentCreateSlice.actions;
export default productSegmentCreateSlice.reducer;

export const productSegmentCreate = (dataModel: any): AppThunk => async (dispatch) => {
    try {
        dispatch(requestStart());
        const axiosInstance = getAxiosInstance();
        const response = await axiosInstance.post('/product-segment', {
