...
export const {requestStart, requestSuccess, requestFailure} = productUpdateSlice.actions;
export default productUpdateSlice.reducer;

export const productUpdate = (dataModel: any): AppThunk => async (dispatch) => {
    try {
        dispatch(requestStart());
        const axiosInstance = getAxiosInstance();
        const response = await axiosInstance.put('/product/' + dataModel.Id, {
            // MediaId: dataModel.MediaId,
            ProductProfileId: dataModel.ProductProfile.Id || dataModel.ProductProfile.code,
            ProductSegmentId: dataModel.ProductSegment.Id || dataModel.ProductSegment.code,
            Code: dataModel.Code,
            Name: dataModel.Name,
