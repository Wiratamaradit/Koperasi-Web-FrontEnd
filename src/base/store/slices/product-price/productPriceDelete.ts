...
export const productPriceDeleteSlice = createSlice({
    name: 'productPriceDel',
...
export const {requestStart, requestSuccess, requestFailure} = productPriceDeleteSlice.actions;
export default productPriceDeleteSlice.reducer;

export const productPriceDelete = (id: any): AppThunk => async (dispatch) => {
    try {
