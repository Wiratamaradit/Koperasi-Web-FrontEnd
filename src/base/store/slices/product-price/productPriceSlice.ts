...
export const {requestStart, requestSuccess, requestFailure} = productPriceSlice.actions;
export default productPriceSlice.reducer;

export const productPriceList = (router?: any, params?: any): AppThunk => async (dispatch) => {
    try {
