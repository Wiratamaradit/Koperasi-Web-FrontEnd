...
export const soldPartyCreateSlice = createSlice({
    name: 'soldPartyPost',
...
export const {requestStart, requestSuccess, requestFailure} = soldPartyCreateSlice.actions;
export default soldPartyCreateSlice.reducer;

export const soldPartyCreate = (dataModel: any): AppThunk => async (dispatch) => {
    try {
        dispatch(requestStart());
        const axiosInstance = getAxiosInstance();
        const response = await axiosInstance.post('/sold-party', {
